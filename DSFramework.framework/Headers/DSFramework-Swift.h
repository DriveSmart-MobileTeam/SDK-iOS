...
typedef SWIFT_ENUM(NSInteger, DRSActivity, closed) {
...
typedef SWIFT_ENUM(NSInteger, DRSGPSTypes, closed) {
  DRSGPSTypesBad = 3,
  DRSGPSTypesGood = 1,
...
typedef SWIFT_ENUM(NSInteger, DRSResponse, closed) {
  DRSResponseRESPONSE_OK = 0,
  DRSResponseDS_UPLOADING_TRIP = 1,
  DRSResponseDS_FINISH_UPLOADING_TRIP = 2,
};

typedef SWIFT_ENUM(NSInteger, DRSResponseErrors, closed) {
...
typedef SWIFT_ENUM(NSInteger, DRSTripStatus, closed) {
  DRSTripStatusNone = 0,
  DRSTripStatusTest = 1,
  DRSTripStatusGood = 2,
  DRSTripStatusBad = 3,
