...
+ (void)setModeOnline:(BOOL)mode completion:(void (^ _Nonnull)(id _Nullable, NSError * _Nullable))completion;
+ (BOOL)getModeOnline SWIFT_WARN_UNUSED_RESULT;
+ (void)startService;
+ (void)stopService;
+ (void)getBackupAmountWithCompletion:(void (^ _Nonnull)(id _Nullable, NSError * _Nullable))completion;
+ (DRSCheckStatus * _Nonnull)checkService SWIFT_WARN_UNUSED_RESULT;
+ (void)forceSendData;
+ (DRSInfoTrip * _Nullable)tripInfo SWIFT_WARN_UNUSED_RESULT;
+ (void)pauseServiceWithCompletion:(void (^ _Nonnull)(id _Nullable, NSError * _Nullable))completion;
+ (void)reStartService;
+ (BOOL)isPaused SWIFT_WARN_UNUSED_RESULT;
+ (void)setMotionStartWithEnabled:(BOOL)enabled completion:(void (^ _Nonnull)(id _Nullable, NSError * _Nullable))completion;
+ (void)setBluetoothStartWithEnabled:(BOOL)enabled;
+ (NSArray<DRSBluetoothDevice *> * _Nonnull)getAllBluetoothDevices SWIFT_WARN_UNUSED_RESULT;
+ (NSArray<DRSBluetoothDevice *> * _Nonnull)getBluetoothDevices SWIFT_WARN_UNUSED_RESULT;
+ (void)setBluetoothDevicesWithDevices:(NSArray<DRSBluetoothDevice *> * _Nonnull)devices;
...
enum DRSTripStatus : NSInteger;
enum DRSGPSTypes : NSInteger;

SWIFT_CLASS("_TtC11DSFramework14DRSCheckStatus")
@interface DRSCheckStatus : NSObject
...
@property (nonatomic) enum DRSTripStatus tripStatus;
...
typedef SWIFT_ENUM(NSInteger, DRSTripStatus, open) {
  DRSTripStatusNone = 0,
  DRSTripStatusTest = 1,
  DRSTripStatusGood = 2,
  DRSTripStatusBad = 3,
